...
export function KurdishLogoIcon({ size = 40, className = '' }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="kli-bg" x1="0" y1="0" x2="0" y2="512" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#0D3D20"/>
          <stop offset="100%" stopColor="#1A6B3A"/>
        </linearGradient>
      </defs>
      <rect width="512" height="512" rx="92" fill="url(#kli-bg)"/>
      {/* Mountains — 3 triangles, drawn behind eagle */}
      <path
        d="M0,512 L0,432 L100,330 L212,432 L256,265 L300,432 L412,320 L512,430 L512,512 Z"
        fill="#2D7A4F"
      />
      <path d={EAGLE_PATH} fill="#FFFFFF"/>
    </svg>
  )
}

export function KurdishLogoFavicon() {
  return (
    <svg viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="klf-bg" x1="0" y1="0" x2="0" y2="512" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#0D3D20"/>
          <stop offset="100%" stopColor="#1A6B3A"/>
        </linearGradient>
      </defs>
      <rect width="512" height="512" rx="92" fill="url(#klf-bg)"/>
      <path
        d="M0,512 L0,432 L100,330 L212,432 L256,265 L300,432 L412,320 L512,430 L512,512 Z"
        fill="#2D7A4F"
      />
...
export function KurdishLogoFull({ className = '' }) {
  return (
    <div className={`flex flex-col items-center ${className}`}>
      <KurdishLogoIcon size={88} />
      <h1 className="text-5xl font-display font-bold text-white mt-5 tracking-tight drop-shadow-lg">
        Fêrbûn
      </h1>
      <p className="text-white/65 text-base mt-2 tracking-widest font-medium uppercase text-sm">
        Kurmandji · Kurdish
      </p>
    </div>
  )
